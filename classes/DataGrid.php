                  ...
                  case 'link':
                     ...
                     for ($l = 0; $l < count($head['links']); $l++) {
                        ...
                        if (defined("ADMIN_PATH")) {
                           $line .= (isset($head['links'][$l]['actionJS']) ? '<button tpye="button"  onclick="' . $head['links'][$l]['actionJS'] . '(' . (isset($head['links'][$l]['id']) ? $d[$head['links'][$l]['id']] : '') . ')" ' : '<a ') . (isset($head['links'][$l]['href']) ? ' href="' . Tools::baseUrl() . ADMIN_PATH . '/?controller=' . $head['links'][$l]['href'] . '&id=' . $d[$head['links'][$l]['id']] . '&token=' . Tools::getValue('token')   : '') . '" class="' . $margin . ' ' . $action . ' btn btn-xs btn-default"><i class="' . (isset($head['links'][$l]['icon']) ? $head['links'][$l]['icon'] : '') . '"></i>' . (isset($head['links'][$l]['label']) ? $head['links'][$l]['label'] : '') . (isset($head['links'][$l]['actionJS']) ? '</button>' : '</a>');
                        } else {
                        ...
                        // if (defined("ADMIN_PATH")) {
                        //    $line .= '<a href="' . (isset($head['links'][$l]['href']) ? Tools::baseUrl() . ADMIN_PATH . '/?controller=' . $head['links'][$l]['href'] . '&id=' . $d[$head['links'][$l]['id']] . '&token=' . Tools::getValue('token')   : '') . '" class="' . (isset($head['links'][$l]['class']) ? $head['links'][$l]['class'] : '') . ' ' . $margin . ' btn btn-xs btn-default"><i class="' . (isset($head['links'][$l]['icon']) ? $head['links'][$l]['icon'] : '') . '"></i>' . (isset($head['links'][$l]['label']) ? $head['links'][$l]['label'] : '') . '</a>';
                        // } else {
                     ...
                     //    if (defined("ADMIN_PATH")) {
                     //       $line .= '<a href="' . (isset($link['href']) ? Tools::baseUrl() . ADMIN_PATH . '/?controller=' . $link['href'] . '&id=' . $d[$link['id']] . '&token=' . Tools::getValue('token')   : '') . '" class="' . (isset($link['class']) ? $link['class'] : '') . '"><i class="' . (isset($link['icon']) ? $link['icon'] : '') . '"></i>' . (isset($link['label']) ? $link['label'] : '') . '</a>';
                     //    } else {
